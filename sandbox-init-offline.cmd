...
powershell.exe -command "Start-Process -Wait -FilePath "C:\WindowsSandbox\Tools\7z2201-x64.exe" -ArgumentList "/S" -PassThru"
powershell.exe -command "Copy-Item "C:\WindowsSandbox\SandboxFiles" -Destination "C:\Users\WDAGUtilityAccount\Desktop\SandboxFiles" -recurse -Force"